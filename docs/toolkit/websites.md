...
每名用户每月有 **400,000 token** 使用额度，剩余额度可在页面左下角查看。Token 并不等同于提问次数或汉字数；输入和输出越长，消耗通常越多。

!!! warning "合理使用 AI"
    AI 生成内容可能存在事实、引用或表达错误，使用后仍需自行核对。完成课程作业时，应遵守课程对生成式 AI 和学术诚信的要求；不要上传个人敏感信息、未公开研究数据或受保密要求约束的材料。
